...
## [0.38.0](https://github.com/lionel1704/sn_routing/compare/v0.1.50...v0.38.0) (2021-04-01)
...
* add Envelope and InfrastructureQuery ([e0b999f](https://github.com/lionel1704/sn_routing/commit/e0b999f961b971b068cad65bfe8e8f938bf4ab41))
* add sibling key to Event::EldersChanged ([afd33e3](https://github.com/lionel1704/sn_routing/commit/afd33e3607b6a467145042fffd9ff274dd5c89b4))
* do not create connection when failed to send to client ([d5eadd8](https://github.com/lionel1704/sn_routing/commit/d5eadd8dc2ae88af2ed26f2e9b0d58c20a69a516))
* having EldersInfo change candidate considered as DKG in progress ([6137123](https://github.com/lionel1704/sn_routing/commit/61371230e2eab7ceff4fd80073843d6b46ff4adf))
* implement new SectionChain that can resolve forks ([a3d786f](https://github.com/lionel1704/sn_routing/commit/a3d786feb6f2bf6314c550423ec2789313fbf7be))
* improve fork diagnostics ([dbf9807](https://github.com/lionel1704/sn_routing/commit/dbf98072a98bba734c6e0458936fa3aaa56ddeb6))
* keep the genesis key and use it for fallback proofs ([99fb5ca](https://github.com/lionel1704/sn_routing/commit/99fb5cacb4bd0782e3cbea3065b01c47ab1ee840))
* last byte of node's name represents its age ([69cef7a](https://github.com/lionel1704/sn_routing/commit/69cef7aa7564b7ce86374de22314431c88073470))
* log send to client error ([ddeff5e](https://github.com/lionel1704/sn_routing/commit/ddeff5e0bf41dfdba3430a8df9ed4b51224822f9))
* make use of sn_messaging crate for messaging serialisation/deserialisation ([cbc4802](https://github.com/lionel1704/sn_routing/commit/cbc48026e6d1e32cde8a3f1f7ab92ca7aed801ad))
* modify bootstrap to use infrastructure queries ([9fb438f](https://github.com/lionel1704/sn_routing/commit/9fb438f6a3c209a50733fd6b894cf4e4ca2861bc))
* new API: Routing::section_key ([486ee61](https://github.com/lionel1704/sn_routing/commit/486ee61dfd77eaffcb2bd86c8c0eba6f470ec678))
* notify client of incorrect section_key ([c54f034](https://github.com/lionel1704/sn_routing/commit/c54f034fdc304106d1a3e56e00012773b1e85a9d))
* remove neighbour restriction ([269cff0](https://github.com/lionel1704/sn_routing/commit/269cff02f17da755996f8189d20d4c1b2d2f3101))
* remove old DKG sessions ([c8db72f](https://github.com/lionel1704/sn_routing/commit/c8db72f8120c538ed41cbe1d036106ba3c0c04d9))
* remove unused Error::NodeMessaging variant ([0b70c28](https://github.com/lionel1704/sn_routing/commit/0b70c28792076599af88dd61f9f6482116c2f3e4))
* remove unused events and event properties ([238a301](https://github.com/lionel1704/sn_routing/commit/238a3016a1731a3abc7ca91b83e546992af85ec0))
* replace (old) SectionProofChain with (new) SectionChain ([03fb82c](https://github.com/lionel1704/sn_routing/commit/03fb82cbf20b8f881bdb0df6a781e3f95f8f0118))
* support adding additional proof chain keys to user messages ([2275730](https://github.com/lionel1704/sn_routing/commit/2275730e276a5296dfe3a6b8c95fb6f516787aba))
* support dst accumulation with any message variant ([cc2f413](https://github.com/lionel1704/sn_routing/commit/cc2f41361162a9ab0b2eab3d144de6cfb8152fe3))
* use src from itinerary for dst accumulated user message ([31838e9](https://github.com/lionel1704/sn_routing/commit/31838e99772cf8e2cc3cc901ba3ce47466270d11))
* use supermajority agreement + increase elder size to 7 ([b729a87](https://github.com/lionel1704/sn_routing/commit/b729a870b58ea1e99099a374e4d21da76109b7f5))
* **accumulation:** add support for accumlation at dest node ([f892838](https://github.com/lionel1704/sn_routing/commit/f892838c994f243e6be17b5276b1c80ff10f5c3a))
* **chain:** expose SectionChain via API ([1590414](https://github.com/lionel1704/sn_routing/commit/15904147c279bbdd628fd3048d00d706e81061ea))
* **enduser:** add mapping between socketaddr and pk ([1ff902d](https://github.com/lionel1704/sn_routing/commit/1ff902da2f28d89ed6ecb3efe502efea8476135e))
* **event:** add separate genesis event ([681d2c7](https://github.com/lionel1704/sn_routing/commit/681d2c7c4d244f0ebf9016169c5b23c406b9f723))
* **event:** expose previous key in elderschanged ([0718e0c](https://github.com/lionel1704/sn_routing/commit/0718e0ca7d11fb3cd4b0d3571909f3318514ec0c))
* **event:** update elders_changed event ([af37d06](https://github.com/lionel1704/sn_routing/commit/af37d065b3eb3171ec9f68e4e665ad89ef01da81))
* add bootstrap message backlog ([75f0a5c](https://github.com/lionel1704/sn_routing/commit/75f0a5c751835aba15a3cd42ae3b30900f6b1428))
* add stress test example ([cf25c48](https://github.com/lionel1704/sn_routing/commit/cf25c48d3ba613db0a1e631620727a31f87d2661))
* allow rejoin with same name ([ded038d](https://github.com/lionel1704/sn_routing/commit/ded038d8526246fab6c8a9c63918a74a02a4848e))
* cancel running timers on drop ([d8f420f](https://github.com/lionel1704/sn_routing/commit/d8f420f239ef3c2e0311681f4b620c230326d250))
* carry out resource proofing during bootstrap ([a047ca1](https://github.com/lionel1704/sn_routing/commit/a047ca1f88c65cc1d9b99c0602b856bb7acb4f9b))
* do not expose BLS secret key share ([e8fa12e](https://github.com/lionel1704/sn_routing/commit/e8fa12e4b528ce1e23657c2a2450f48adc3d20de))
* expose `Event` directly, hide `event` module ([d940b77](https://github.com/lionel1704/sn_routing/commit/d940b77effde39376b8c7671dbf94f6607ce46ba))
* implement DKG message bouncing ([551c427](https://github.com/lionel1704/sn_routing/commit/551c4276b0c737269716fe05da83fc2b34cfd63c))
* implement lost peer detection ([cbc57ba](https://github.com/lionel1704/sn_routing/commit/cbc57baea9d44637d7439d62872dd8bde0df40b9))
* implement message resending ([cc2fcbd](https://github.com/lionel1704/sn_routing/commit/cc2fcbd163eb80ec85a567b0eb8bc160fc84a312))
* implement proper node termination ([0fbced8](https://github.com/lionel1704/sn_routing/commit/0fbced8a2efaac6be063aee2fb30b8f74f2e7df8))
* improve Comm api and documentation ([9ecfe8a](https://github.com/lionel1704/sn_routing/commit/9ecfe8a5cf949ec741d6cf197930a83515538412))
* joins_allowed flag to toggle accept new node or not ([5def794](https://github.com/lionel1704/sn_routing/commit/5def79408bfe16e37d7455b5c83037415429ce78))
* make the log identifier work again ([48d7ce7](https://github.com/lionel1704/sn_routing/commit/48d7ce79d15f6b7da1cea328980aff835690b4ca))
* make the resend delay configurable ([8a0d043](https://github.com/lionel1704/sn_routing/commit/8a0d043dc4079a4ff677b211c07bc4ffccdf9fdb))
* minor changes to the Event enum ([56e658f](https://github.com/lionel1704/sn_routing/commit/56e658fe6a2fb0b2e1aeac8018f126512c944345))
* notify when key got changed during relocation ([2540a27](https://github.com/lionel1704/sn_routing/commit/2540a27a3aafac61979d6b664e62655796c795ad))
* ping peers on connection loss to detect if they went offline ([d6be64f](https://github.com/lionel1704/sn_routing/commit/d6be64f087341f31838d51dfbdfb067ed24895df))
* relocate all joining infants during startup phase ([492f4d7](https://github.com/lionel1704/sn_routing/commit/492f4d7a5715fe48d1d1757b100fc8ac186ba669))
* relocate one infant with age increased by one when set joins_allowed flag ([03d9827](https://github.com/lionel1704/sn_routing/commit/03d9827e591bf79fa5ecb775801ff8c325109fde))
* relocate only the oldest peers that pass the relocation check ([d7855b5](https://github.com/lionel1704/sn_routing/commit/d7855b5cf3e18d49517f7f4daac96f0add47a8cf))
* relocation during startup no-longer required ([cf937e4](https://github.com/lionel1704/sn_routing/commit/cf937e47bf41cc8b8724e7496f5040e69f95d67e))
* remove join timeout - to be handled by the upper layers instead ([cb4f6fe](https://github.com/lionel1704/sn_routing/commit/cb4f6feb6dc9949e1b865f6c8876d34cfd93322f))
* remove resend delay ([9b0971e](https://github.com/lionel1704/sn_routing/commit/9b0971e1aea11b2ada4cc56d70d1d0195631aaad))
* remove Variant::Ping ([18a9d40](https://github.com/lionel1704/sn_routing/commit/18a9d40f9e8a8210b53a00afbe40bada2abcac3f))
* set filter number boundary ([c129bff](https://github.com/lionel1704/sn_routing/commit/c129bff69d92400202bcefd1983eb028e3a26155))
* start the first node with higher age ([d23914e](https://github.com/lionel1704/sn_routing/commit/d23914ed998eb415a0e0f7af616eca6bf6ea4333))
* support multiple concurrent DKGs ([98fc101](https://github.com/lionel1704/sn_routing/commit/98fc10194ddd73387a5539ad1e29423a224583d5))
* updates for section key response changes ([71f89d8](https://github.com/lionel1704/sn_routing/commit/71f89d8c54008ff9974f740eff5be9ac2b893f26))
* use tracing for logging ([a68af40](https://github.com/lionel1704/sn_routing/commit/a68af409d0700eaf6c25d1ccac65afc0626902d0))
* use XorName instead of Prefix for section message src ([d2347ee](https://github.com/lionel1704/sn_routing/commit/d2347eee21a3d5e86ae0c76e133e00cc1a850eeb))
* **age:** add age getter API ([07430a0](https://github.com/lionel1704/sn_routing/commit/07430a07f5c4772014fc9db7108d3c9404f5702a))
* **api:** expose an async event stream API, and adapt node module to use qp2p async API ([a42b065](https://github.com/lionel1704/sn_routing/commit/a42b065edad3225ccbcad30ed9755e7eff78cd10))
* **comm:** detect lost connections ([f4e9e3a](https://github.com/lionel1704/sn_routing/commit/f4e9e3a00ce5b8905be06d7d6ffa6ea522108466))
* **keycache:** adds a key cache and removes exposure of secret key ([b312446](https://github.com/lionel1704/sn_routing/commit/b312446b6db2c2beaf6007d39619dd8969fc8428))
* **messages:** remove MsgEnvelope ([57df069](https://github.com/lionel1704/sn_routing/commit/57df069f6ed5d7c9afe3b665158181cce70ceb15))
* **node:** cache Connections to nodes ([a78c305](https://github.com/lionel1704/sn_routing/commit/a78c30596400e360b880caafb41a8c94c3bc5b67))
* **stress test:** improve output ([33eac1b](https://github.com/lionel1704/sn_routing/commit/33eac1b61383f231d0c34657db98d00cc84cf7c3))
* **upnp:** use new version of qp2p with UPnP and echo service ([afb609e](https://github.com/lionel1704/sn_routing/commit/afb609e030acf3002599e2cee14e80f81dae7b21))
* use unbounded channel for Events ([fb5a3aa](https://github.com/lionel1704/sn_routing/commit/fb5a3aa2eb1af018d82fcdfbe11a9a3b156525b1))


### Bug Fixes

* add missing routing to client of relayed client message ([fbde5b1](https://github.com/lionel1704/sn_routing/commit/fbde5b10d734fcf5037b0d37767ba5093376e46e))
* addresss review comments ([27dcac5](https://github.com/lionel1704/sn_routing/commit/27dcac57b78daa9b41c481ed3970453d172720b4))
* adults not able to send non-aggregated messages ([9248cd0](https://github.com/lionel1704/sn_routing/commit/9248cd071a7c5f2a7dd95ac201a40267c3ac3e6a))
* always send their Offline vote to relocated elders ([7f77e97](https://github.com/lionel1704/sn_routing/commit/7f77e970adaf30c4653a60299829501e90453a4e))
* avoid invalidating signature when resending bounced Sync message ([d482dab](https://github.com/lionel1704/sn_routing/commit/d482dab96b8e2bdd5d49aa1579b50bce8f459e64))
* bounce untrusted messages directly to the original sender ([1bed232](https://github.com/lionel1704/sn_routing/commit/1bed232ba085aa46fd71b3469366f5ab029aab8c))
* bug in SectionChain::minimize ([0eef78e](https://github.com/lionel1704/sn_routing/commit/0eef78e2f7d3a729e38c2421a54be58ff07ff5d4))
* check trust with all known keys, not just the src matching ones ([2c9a1b2](https://github.com/lionel1704/sn_routing/commit/2c9a1b280cee471514f8254cd82cf19deb1383b5))
* correctly handle section chain extend edge case ([cae05ba](https://github.com/lionel1704/sn_routing/commit/cae05bab837e66e2a6f7754133f4937451e0bbe0))
* cover all cases of RelocatePromise handling ([5966d3d](https://github.com/lionel1704/sn_routing/commit/5966d3db21045d7e56851bd22c2d46e9ebdf50bb))
* don't send OtherSection or vote TheirKnowledge to our section ([95f14d8](https://github.com/lionel1704/sn_routing/commit/95f14d8ef869d263cc782e7faf91e7bc160dcf16))
* enable relocation again ([f9fde30](https://github.com/lionel1704/sn_routing/commit/f9fde30572e19e2ef50cb3f75a47714f8670332a))
* ensure section elders info is always signed with the last chain key ([82fad1a](https://github.com/lionel1704/sn_routing/commit/82fad1aca7d55e5b83b3af3658ffeae5f3873581))
* ignore Sync messages not for our section ([6d90fcf](https://github.com/lionel1704/sn_routing/commit/6d90fcff2b2a1873b56915b8f3dc202b5394681b))
* issues pointed out in review comments ([d9a986e](https://github.com/lionel1704/sn_routing/commit/d9a986e5f4df278dd87cf08cf6b77ab725a70455))
* make SectionChain::check_trust more strict ([8dcd021](https://github.com/lionel1704/sn_routing/commit/8dcd0215ba4cb8d8d2d57c3782fbdd267a278065))
* make sure sibling section info is valid and trusted ([2044b11](https://github.com/lionel1704/sn_routing/commit/2044b1106397071b581af8a64fae453d78f4ab3b))
* no split in first section ([81a716f](https://github.com/lionel1704/sn_routing/commit/81a716fce20da6a2521c0a41f2133d6704568d28))
* post-rebase issues ([906ef03](https://github.com/lionel1704/sn_routing/commit/906ef031585f3db19a546928e76c8304a7f3c7f3))
* prevent creating Section with elders info signed with wrong key ([f0f839c](https://github.com/lionel1704/sn_routing/commit/f0f839cb124c94fede41c9a21882e6b00c5743de))
* reduce unneeded lazy messages ([0498f24](https://github.com/lionel1704/sn_routing/commit/0498f2447cc7cee91b1a897b0227d806861782a3))
* remove potential panic in SignedRelocateDetails ([23d0936](https://github.com/lionel1704/sn_routing/commit/23d09363211fc6d957f74ef85bc103c27685644b))
* restore EldersChange to a previous version ([0a85b87](https://github.com/lionel1704/sn_routing/commit/0a85b879d5a2173daf24f49fbb3e106ecc0a0f5d))
* send OtherSection to src of the original message, not src section ([cd3e382](https://github.com/lionel1704/sn_routing/commit/cd3e38226af242950ce06797ea2ebf308b9cea31))
* **bootstrap:** avoid duplicate GetSectionRequest ([84327e2](https://github.com/lionel1704/sn_routing/commit/84327e2521dfcace503886e3d4b79c3118cc4464))
* **bootstrap:** require GetSectionResponse to match our destination, not name ([4f484f1](https://github.com/lionel1704/sn_routing/commit/4f484f1ea93f5d83180d5c77fcb5b3a680322d31))
* **dkg:** allow multiple pending key shares ([92dfc70](https://github.com/lionel1704/sn_routing/commit/92dfc70a8bd18108f0c3a2f6d657b1e72e0a76cd))
* **dkg:** avoid mixing DKG messages from different generations ([e68ba2a](https://github.com/lionel1704/sn_routing/commit/e68ba2aad975285c3968a67b38040d110c4f7d78))
* **test:** increase the number of nodes in the drop test from 3 to 4 ([9ce0ec7](https://github.com/lionel1704/sn_routing/commit/9ce0ec7da7483eacd9f5941bad470a4a821d0fd3))
* redirect to our elders on mismatching GetSectionRequest as adult ([22c4745](https://github.com/lionel1704/sn_routing/commit/22c47453a50d79b47771c9afb682d3cac88aeb12))
* remove offline elder from vote recipients ([3bcea21](https://github.com/lionel1704/sn_routing/commit/3bcea21ceb00feacc52843cc435fe875d3ed3f84))
* remove unnecessary error mapping ([0f3418b](https://github.com/lionel1704/sn_routing/commit/0f3418b2ea4d66f438604ded2682d76f95e70d6f))
* remove use of wildcard match and unimplemented macro ([84c53d8](https://github.com/lionel1704/sn_routing/commit/84c53d8db16f1ab237c46ad5e8221b2a80758d54))
* resolve a doc failure ([d51f0c6](https://github.com/lionel1704/sn_routing/commit/d51f0c62534fe03add884bdb060105c1bd7c394b))
* respond with GetSectionResponse::Redirect on missing pk set ([69a1fb8](https://github.com/lionel1704/sn_routing/commit/69a1fb840cbbb54b8ccb5af8856e3991d3ac46dd))
* send messages with correct MessageKind byte ([6756b43](https://github.com/lionel1704/sn_routing/commit/6756b43d969d26afe9305ee4ff2851c6e9193495))
* use chain main branch length as the DKG generation ([ed3a54e](https://github.com/lionel1704/sn_routing/commit/ed3a54e635661f6bb59d968a8a4c3d091f2a8587))
* **clippy:** remove clone (undetected in local clippy check) ([da6cbc7](https://github.com/lionel1704/sn_routing/commit/da6cbc7af578649907202d74676caee1623af278))
* **comm:** dont hold on to messages sent on a channel that is unused ([92856cd](https://github.com/lionel1704/sn_routing/commit/92856cd8daf51af109405d1b9b58b7fa0a5f2d9c))
* **dkg:** detect corrupted DKG outcome ([ec53c63](https://github.com/lionel1704/sn_routing/commit/ec53c63a78e5cf776219b75cb2c678710f9b34ae))
* **dst-accumulation:** verify aggregated signature with proof chain ([bd99595](https://github.com/lionel1704/sn_routing/commit/bd99595379307f0f6b19bccaac0b3b8e145e0fcf))
* allow only one relocation at the time per node ([0e4d05f](https://github.com/lionel1704/sn_routing/commit/0e4d05f7f06349512a63a912a832cbab0631e429))
* bounce DKG message only if node has no ongoing session ([350b75d](https://github.com/lionel1704/sn_routing/commit/350b75db30fbdec86e14d48ff4f1740be39ddc00))
* consider also relocated current elders for elder candidates ([fffc946](https://github.com/lionel1704/sn_routing/commit/fffc94696fc82b73711b48c1ba4d83d21e2dd09b))
* do not require resource proof for relocated node + test ([667e1fb](https://github.com/lionel1704/sn_routing/commit/667e1fb156aa1dfad68388f95082d87807898a3f))
* don't fail in update_state if secret key share is missing ([97d8266](https://github.com/lionel1704/sn_routing/commit/97d8266042d1c21c02b8015aa5be38ad009c8224))
* handle invalid bootstrap response by retuning error ([d5ee338](https://github.com/lionel1704/sn_routing/commit/d5ee338bf79c21d7e136bd8becb84d49fd3a2997))
* ignore elders update with incorrect prefix ([dfc9c60](https://github.com/lionel1704/sn_routing/commit/dfc9c60278fe78fdd5fbb4de14b5cc2721dbf570))
* ignore invalid bootstrap response ([3d8cfd5](https://github.com/lionel1704/sn_routing/commit/3d8cfd583c16cff7c25b82c142c80aa6348852e3))
* **stress test:** fix log to file and probe message destination ([c933605](https://github.com/lionel1704/sn_routing/commit/c933605df7847b05afd5a0b497cc315381e99955))
* **stress test:** ignore InvalidSource errors when sending probes ([adabf82](https://github.com/lionel1704/sn_routing/commit/adabf82f7da0f8b6669e8f28cc9fb7fca02f67b2))
* avoid over relocation ([989529c](https://github.com/lionel1704/sn_routing/commit/989529cafd1903e9009f4f66b1d111819d89be9c))
* clear peer_mgr candidate post pfx change. ([57cd490](https://github.com/lionel1704/sn_routing/commit/57cd490069c961098e3a242fcf439ab2f1631bb5))
* don't ack hop messages in Client state ([9539c05](https://github.com/lionel1704/sn_routing/commit/9539c05f3133a487dd5f0806418283a880eb411e))
* expand ConnInfoReq handling conditions. ([d081800](https://github.com/lionel1704/sn_routing/commit/d0818004f90d5f67e5d03f974967ba8829ae2a6a))
* forward ResurceChallenge to the bootstrap task ([2552f06](https://github.com/lionel1704/sn_routing/commit/2552f0631e32a8e442ef1291b537c1ef969bca6d))
* handle message send to self ([a1c26ff](https://github.com/lionel1704/sn_routing/commit/a1c26ff62d2dfd0bab12e35b266ce46eee024b77))
* lost peer handling ([1d95194](https://github.com/lionel1704/sn_routing/commit/1d95194f7a074d0561a4199cf106cca541af70f4))
* no longer use serde macro derive ([2116420](https://github.com/lionel1704/sn_routing/commit/2116420e2d205499c3c030acafa036df73c9664c))
* prevent losing incoming messages during bootstrapping ([3c9357e](https://github.com/lionel1704/sn_routing/commit/3c9357e9cc9d77d5da35df5fb856b08f3ac674b3))
* reject SectionInfo votes not voted by a participant ([c40dc12](https://github.com/lionel1704/sn_routing/commit/c40dc12bb1f64f6b22695c0541479c2dbc26fd8f))
* rename mock/quick_p2p to mock/quic_p2p ([067fab0](https://github.com/lionel1704/sn_routing/commit/067fab09f2e2dcf185dd8bd5987bf8c99c88029d))
* send Sync messages on split even when demoted ([5f42b78](https://github.com/lionel1704/sn_routing/commit/5f42b78c4bcd68720399d9553512057d8b7d4d0d))
* trust check failure of Sync message sent to non-elders ([5520c18](https://github.com/lionel1704/sn_routing/commit/5520c182e1f3c29ce560d3fbb6e1e7e74324ac47))
* use keys not key indices to check whether elders changed ([a99a07f](https://github.com/lionel1704/sn_routing/commit/a99a07f80b706d7fe84b5d970ee10999910db395))
* **comm:** try to re-connect after previously failed send ([08d9410](https://github.com/lionel1704/sn_routing/commit/08d9410b575cfb26f80cc3efe896a73da432f98d))
* **dkg:** backlog messages with unknown DKG key ([03873c1](https://github.com/lionel1704/sn_routing/commit/03873c11224d26bf587a4b3366d51e6847b91f06))
* **dkg:** handle DKG with single participant ([00c2efa](https://github.com/lionel1704/sn_routing/commit/00c2efa6fb042a2e97008713f10a28e9b27a62e7))
* **stress test:** fix sent probe messages counter ([b9b7530](https://github.com/lionel1704/sn_routing/commit/b9b7530fe383142541da5164e46455fe84287565))
* **stress-test:** fix probe message sending ([a8a184c](https://github.com/lionel1704/sn_routing/commit/a8a184c70f57801140d4fb521b230485ab353727))
* use age assigned by section ([4db6351](https://github.com/lionel1704/sn_routing/commit/4db63514d4b4f8fe226bc76d97ca33f0e646165a))
* **dkg:** handle delayed DKG outcome ([c58611b](https://github.com/lionel1704/sn_routing/commit/c58611b5bc8343bffef08f3a5464bed3109380f8))
* **test:** account for relocations in test_startup_section_bootstrapping ([53196a5](https://github.com/lionel1704/sn_routing/commit/53196a5ef8a82a073383f56f1f58ac84dbf28b9f))
* **test:** dont assert new joining node is not instantly relocated ([9a18b4c](https://github.com/lionel1704/sn_routing/commit/9a18b4c0230142dda3a3c64a5fd8aaa0c67fc3b6))
* Remove old compatible neighbour pfx not restricted to a strict parent/child prefix in Chain on updating neighbour_infos. ([#1579](https://github.com/lionel1704/sn_routing/issues/1579)) ([6d23fa3](https://github.com/lionel1704/sn_routing/commit/6d23fa3390cac5462988ac069e93ad5199dcc57f))
* resolve clippy errors of non-mock tests ([94eda60](https://github.com/lionel1704/sn_routing/commit/94eda60e3eae1fd033903038e4271a955c729112))
* resolve failing example ([121ce95](https://github.com/lionel1704/sn_routing/commit/121ce952993ad7e29e055d27b33f164331cd9252))
* send Event::Connected only after transition to Approved ([dbe0593](https://github.com/lionel1704/sn_routing/commit/dbe059361876c09f00323b7eb7fd8d95bcb151ee))
* take ages into account when calculating DkgKey ([824d229](https://github.com/lionel1704/sn_routing/commit/824d2293f17e3d64a6282544556d0ffec3d5e744))
* **event:** export qp2p SendStream and RecvStream for consumers to use ([65af16f](https://github.com/lionel1704/sn_routing/commit/65af16fd62055999460dd7aeec91b2e0eaab6c68))
* use the latest section key when updating non-elders ([219f98d](https://github.com/lionel1704/sn_routing/commit/219f98d9b3e1a51e5c7eb32fd3857a5de592081f))
* vote for sibling knowledge after parsec reset ([090663f](https://github.com/lionel1704/sn_routing/commit/090663f24dcb165b98d0ccb16b1f5d32614f3b91))


### api

* remove NetworkParams ([686c248](https://github.com/lionel1704/sn_routing/commit/686c2482358e03b94779c0cde9a61af2b83b6575))
* remove size fields within routing::Config ([9dfb935](https://github.com/lionel1704/sn_routing/commit/9dfb935afd9bdfe4dcc65d37e1cdbb93ac21fa06))


* **dep:** update qp2p dependency ([1eced85](https://github.com/lionel1704/sn_routing/commit/1eced85950190a39efbe74b195f846d9c36431cb))
* DT dep update ([7fb8a4a](https://github.com/lionel1704/sn_routing/commit/7fb8a4a6ebed7e1990de4acdd38feca89cb52d1a))
* **data-types:** upgrading data-types to v0.16.0 and sn_messaging to v8.0.0 ([5e39755](https://github.com/lionel1704/sn_routing/commit/5e397559e7f4b907276f2a2f689cb519d304b8be))
* **deps:** update sn_messaging, sn_data_types ([367b673](https://github.com/lionel1704/sn_routing/commit/367b6731b90b7211679282b2fcaa8852f3449ccd))
* **messaging:** add expected aggregation scheme, and use an itinerary ([a79d2d0](https://github.com/lionel1704/sn_routing/commit/a79d2d0f837354c46282410d387b2276af525848))
* **tokio:** upgrade tokio to v1.2.0 and qp2p 0.10.0 ([e5adc1a](https://github.com/lionel1704/sn_routing/commit/e5adc1a6e21c4b7f3aa62497535b7740cd08a3f3))
* fix clippy errors with version 1.50.0 of rust ([b6b385a](https://github.com/lionel1704/sn_routing/commit/b6b385aa1d05a8ac908f568d4537bb64589cd470))
* remove `Error::UntrustedMessage` ([dbcf0db](https://github.com/lionel1704/sn_routing/commit/dbcf0db471f2b234342fdeeb68d5cf7aaff50846))
* remove Error::BadLocation ([3391c7f](https://github.com/lionel1704/sn_routing/commit/3391c7f1d49e050ae2fe580816a10add68388d14))
* remove the Routing state machine ([cfa19ff](https://github.com/lionel1704/sn_routing/commit/cfa19ff2151976996d425a3a10e863b03abf6331))
* rename Instance to Routing ([a227e3f](https://github.com/lionel1704/sn_routing/commit/a227e3fe03894545956c7899d8b120b375065281))
* rename Node to Instance and NodeConfig to Config ([d8d6314](https://github.com/lionel1704/sn_routing/commit/d8d63149fce5742af1d2151b91ee974c24ada269))
